    ...
    <View style={styles.container}>
      ...
      <View style={[styles.bottomBar, { paddingBottom: insets.bottom + 12 }]}>
        ...
        <View style={styles.bottomBarContent}>
          ...
          >
            <Text style={[styles.saveBtnText, isSaved && { color: Colors.purpleLight }]}>
              {isSaved ? '⊟' : '⊞'}
            </Text>
          </TouchableOpacity>
          <GradientButton
...
const styles = StyleSheet.create({
  ...
  notFoundText: { color: Colors.textSecondary, fontFamily: FontFamily.medium, fontSize: FontSize.lg },
  backLink: { color: Colors.purpleLight, fontFamily: FontFamily.medium, fontSize: FontSize.base },
  ...
  artistName: { fontFamily: FontFamily.semibold, fontSize: FontSize.base, color: Colors.textPrimary },
  artistVerified: { fontSize: 11 },
  artistSub: { fontFamily: FontFamily.regular, fontSize: FontSize.sm, color: Colors.textSecondary },
  artistStats: { fontFamily: FontFamily.regular, fontSize: FontSize.xs, color: Colors.textTertiary },
  artistArrow: { color: Colors.textTertiary, fontSize: 18 },
  capacityHeader: {
    flexDirection: 'row',
