          ...
          <View style={styles.avatarRow}>
            ...
            <View style={styles.actionButtons}>
              <GradientButton
                ...
                size="sm"
                gradient={isFollowing ? [COLORS.softGray, COLORS.softGray] : Colors.gradients.purple}
                textStyle={isFollowing ? { color: COLORS.gray } : undefined}
              />
...
const styles = StyleSheet.create({
  ...
  stat: {
    ...
    paddingVertical: 14,
    borderRightWidth: 1,
    borderRightColor: 'rgba(31,41,55,0.06)',
  },
  statValue: {
